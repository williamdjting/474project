...
function Home() {
  ...
  useEffect(() => {
    axios
      .get('https://edf43u69z9.execute-api.us-east-2.amazonaws.com/categories')
      .then(res => {
  ...
  function handleSubmit(e) {
    e.preventDefault()
    axios
    .get('https://edf43u69z9.execute-api.us-east-2.amazonaws.com/question/' + categoryEl.current.value + '/' + amountEl.current.value)
    .then(res => {
